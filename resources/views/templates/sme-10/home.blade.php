...
@section('content')
{{-- Navbar --}}
<nav class="bg-amber-800 sticky top-0 z-50 shadow-md">
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <a href="#kontak" class="bg-white text-amber-800 px-6 py-2.5 rounded-full font-semibold">Pesan</a>
    </div>
</nav>
...
<section id="beranda" class="relative text-white">
    <img src="{{
                $profile->cover_image_url ?: static_image('sme-10', 'hero', 'handmade crafts workshop with handmade items, woven baskets, pottery, artisan tools', 'landscape_16_9')
            }}" alt="Craft {{ $tenant->name }}" class="absolute inset-0 w-full h-full object-cover">
    <div class="absolute inset-0 bg-amber-950/55"></div>
    <div class="relative max-w-7xl mx-auto px-4 py-44 text-center">
        <p class="uppercase tracking-[0.3em] text-sm mb-4">Handmade & Kerajinan</p>
        <h1 class="text-4xl md:text-6xl font-bold mb-6">{{ $tenant->name }}</h1>
        <p class="text-xl text-amber-50 mb-10 max-w-2xl mx-auto">{{ $profile->tagline ?? 'Kerajinan tangan berkualitas, dibuat dengan cinta' }}</p>
        <a href="#produk" class="bg-white text-amber-900 px-8 py-3 rounded-full font-bold">Lihat Produk</a>
    </div>
</section>
...
<section id="tentang" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Karya Tangan, Kualitas Tangan</h2>
        <p class="text-gray-600 leading-relaxed max-w-3xl mx-auto mb-12">{{ $profile->description ?? 'Deskripsi usaha kerajinan belum diisi.' }}</p>
        <div class="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div>
                <div class="text-5xl mb-3">🧶</div>
                <div class="font-semibold text-gray-900">Handmade</div>
            </div>
            <div>
                <div class="text-5xl mb-3">♻️</div>
                <div class="font-semibold text-gray-900">Ramah Lingkungan</div>
            </div>
            <div>
                <div class="text-5xl mb-3">🎨</div>
                <div class="font-semibold text-gray-900">Desain Unik</div>
            </div>
        </div>
    </div>
</section>
...
<section id="produk" class="py-20 bg-amber-50">
    <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">Koleksi Kerajinan</h2>
...
<section id="galeri" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">Galeri Karya</h2>
